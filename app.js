...
// ======================
var CLIENTS = [
  {id:'ghost',name:'Ghost',serie:'Power',c1:'#2A1660',c2:'#5B2D9A'},
  {id:'assane',name:'Assane',serie:'Lupin',c1:'#0F2A52',c2:'#1B4A8C'},
  {id:'annalise',name:'Annalise',serie:'Murder',c1:'#4A1020',c2:'#8B1C3A'},
  {id:'sully',name:'Sully',serie:'Top Boy',c1:'#0C2818',c2:'#1A5C32'},
  {id:'tommy',name:'Tommy',serie:'Peaky Blinders',c1:'#1C1C24',c2:'#3A3A48'},
  {id:'walter',name:'Walter',serie:'Breaking Bad',c1:'#0C3818',c2:'#1A6C32'},
  {id:'mareme',name:'Marème',serie:"Maîtresse d'un homme marié",c1:'#3A1A2A',c2:'#7A3550'},
  {id:'apash',name:'Apash',serie:'Validé',c1:'#3A1A08',c2:'#7A3510'},
  {id:'sakho',name:'Sakho',serie:'Sakho & Mangane',c1:'#08303A',c2:'#10606C'},
  {id:'wilson',name:'Wilson',serie:'WHO',c1:'#2A2008',c2:'#5A4510'},
  {id:'ebony',name:'Ebony',serie:'Nemesis',c1:'#2A0818',c2:'#5A1038'}
];
var selectedClient = '';
