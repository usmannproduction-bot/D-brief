...
// ======================
var CLIENTS = [
  {id:'ghost',name:'Ghost',serie:'Power',sig:'sartre1',vp:'faille_gav',c1:'#2A1660',c2:'#5B2D9A'},
  {id:'assane',name:'Assane',serie:'Lupin',sig:'lupin1',vp:'faille_perq',c1:'#0F2A52',c2:'#1B4A8C'},
  {id:'annalise',name:'Annalise',serie:'Murder',sig:'annalise1',vp:'faille_juge',c1:'#4A1020',c2:'#8B1C3A'},
  {id:'sully',name:'Sully',serie:'Top Boy',sig:'topboy1',vp:'faille_gav',c1:'#0C2818',c2:'#1A5C32'},
  {id:'tommy',name:'Tommy',serie:'Peaky Blinders',sig:'tommy1',vp:'faille_perq',c1:'#1C1C24',c2:'#3A3A48'},
  {id:'walter',name:'Walter',serie:'Breaking Bad',sig:'walter1',vp:'faille_juge',c1:'#0C3818',c2:'#1A6C32'},
  {id:'apash',name:'Apash',serie:'Validé',sig:'valide1',vp:'faille_gav',c1:'#3A1A08',c2:'#7A3510'},
  {id:'sakho',name:'Sakho',serie:'Sakho & Mangane',sig:'sakho1',vp:'faille_perq',c1:'#08303A',c2:'#10606C'},
  {id:'wilson',name:'Wilson',serie:'WHO',sig:'who2',vp:'faille_juge',c1:'#2A2008',c2:'#5A4510'},
  {id:'ebony',name:'Ebony',serie:'Nemesis',sig:'nemesis1',vp:'faille_gav',c1:'#2A0818',c2:'#5A1038'}
];
var ciTiming = null;
var selectedClient = '';
...
// ======================
// LA FAILLE (repérer l'anomalie de procédure)
// elements: tableau d'options {t:texte, ok:true/false} — une seule ok=true
// ======================
function F(n, t, q, dos, elements, expl) {
  return { mode: 'faille', n: n, t: t, q: q, dos: dos, elements: elements, expl: expl, pt: 120, wt: 180, vd: 10800000 };
}
...
var ALL_CASES = {
  ...
  faille_gav: F('La Garde à Vue', 'Vice de Procédure', "Karim D. est en garde à vue après un cambriolage. Une seule étape de la procédure rend tout le dossier nul. Laquelle&nbsp;?", "23h50. Karim D., 28 ans, est conduit au commissariat du 8e arrondissement, repéré près d'une bijouterie cambriolée deux heures plus tôt. L'officier de police judiciaire ouvre le registre de garde à vue et consigne chaque étape.\n\nDès son arrivée, on lui notifie son droit de garder le silence et de ne pas s'incriminer. Il demande un médecin : l'examen a lieu dans l'heure. Son avocat, prévenu aussitôt, s'entretient seul avec lui pendant trente minutes.\n\nLes interrogatoires s'enchaînent. Karim n'avoue rien. La garde à vue se prolonge, puis se prolonge encore, et dure finalement 72 heures sans qu'aucun magistrat n'ait été saisi pour la valider. Au matin du troisième jour, il est enfin déféré au parquet.\n\nRelisez chaque étape : l'une d'elles suffit à faire tomber l'ensemble du dossier, aveux et preuves compris.", [
    {t: "La notification du droit au silence dès son arrivée", ok: false},
    {t: "L'examen médical accordé dans l'heure, à sa demande", ok: false},
    {t: "Les 72 heures de garde à vue sans aucune validation par un magistrat", ok: true},
    {t: "L'entretien privé de trente minutes avec son avocat", ok: false}
  ], "La faille : en droit commun, la garde à vue ne peut excéder 48 heures, et toute prolongation au-delà de 24h doit être autorisée par un magistrat. 72 heures sans le moindre contrôle judiciaire, c'est une détention arbitraire. Toute la procédure est frappée de nullité — y compris les aveux et les preuves recueillies."),
  faille_perq: F('La Perquisition', 'Vice de Procédure', "Les enquêteurs perquisitionnent un domicile et saisissent des preuves accablantes. Mais une anomalie rend la saisie irrecevable. Trouvez-la.", "Enquête sur un réseau de recel. Les soupçons se portent sur Sofia M., dont les enquêteurs veulent fouiller l'appartement. Voici le déroulé exact de l'opération, tel qu'il figure au procès-verbal.\n\nLes agents se présentent munis d'un mandat de perquisition régulièrement signé par un juge. Ils sonnent et annoncent l'objet de leur visite. Deux témoins indépendants, requis pour l'occasion, assistent à toute l'opération. Chaque objet saisi est immédiatement inventorié et consigné dans un procès-verbal détaillé, signé par les témoins.\n\nUn seul détail détonne dans ce déroulé impeccable : l'opération a débuté à 5h00 du matin, alors que la ville dormait encore.\n\nTout semble en règle. Pourtant, une de ces lignes annule la totalité des preuves saisies.", [
    {t: "Le mandat de perquisition signé par un juge", ok: false},
    {t: "Le début de la perquisition à 5h00 du matin", ok: true},
    {t: "La présence de deux témoins indépendants", ok: false},
    {t: "L'inventaire et le procès-verbal signés sur place", ok: false}
  ], "La faille : les perquisitions sont en principe interdites entre 21h et 6h du matin. Hors flagrant délit ou autorisation spéciale du juge des libertés, commencer une perquisition à 5h00 viole cette règle. Toutes les preuves saisies au cours de l'opération deviennent irrecevables."),
  faille_juge: F('Le Procès', 'Vice de Procédure', "Au tribunal, tout paraît équitable. Pourtant, une règle fondamentale du procès a été bafouée. Laquelle&nbsp;?", "Le procès de Thomas R. s'ouvre devant le tribunal. L'affaire a été instruite pendant des mois. Voici comment l'audience se déroule.\n\nLe témoin principal prête serment avant de déposer, comme l'exige la loi. L'intégralité des pièces du dossier a été communiquée à la défense bien avant l'audience, lui laissant le temps de préparer sa réplique. L'accusé est assisté de son avocat, présent et actif à chaque instant des débats.\n\nMais en consultant la composition du tribunal, un détail saute aux yeux : le magistrat qui préside l'audience et qui jugera Thomas est exactement le même que celui qui a mené l'instruction de l'affaire, des mois durant, à charge comme à décharge.\n\nApparence d'équité parfaite. Et pourtant, l'un de ces points anéantit le droit à un procès équitable.", [
    {t: "Le témoin principal a prêté serment avant de déposer", ok: false},
    {t: "Toutes les pièces ont été communiquées à la défense avant l'audience", ok: false},
    {t: "Le juge d'instruction de l'affaire préside aussi le procès", ok: true},
    {t: "L'accusé a été assisté de son avocat durant tous les débats", ok: false}
  ], "La faille : le principe de séparation des fonctions interdit formellement au magistrat qui a instruit l'affaire de la juger ensuite. Celui qui a enquêté ne peut être celui qui tranche — c'est une atteinte directe à l'impartialité du tribunal, garantie par le droit à un procès équitable. Le jugement est nul.")
};
...
function buildHome() {
  ...
  sorted.forEach(function(k, idx) {
    var c = CASES[k];
    var isDDJ = (k === ddj);
    var locked = (me.email && !me.sigDone);
    ...
    var badge = c.jm ? '<span style="font-size:10px;padding:3px 10px;background:rgba(255,210,63,.1);border:1px solid rgba(255,210,63,.2);border-radius:10px;color:#FFD23F;margin-left:8px">JUGE</span>' : (c.mode === 'faille' ? '<span style="font-size:10px;padding:3px 10px;background:rgba(124,187,240,.1);border:1px solid rgba(124,187,240,.25);border-radius:10px;color:#7CBBF0;margin-left:8px">LA FAILLE</span>' : '');
    ...
    card.innerHTML =
      ...
      '<div style="display:flex;align-items:center;gap:12px;margin-bottom:28px;position:relative">' +
        ...
        '<div style="font-size:11px;font-weight:800;color:rgba(255,255,255,.12);letter-spacing:3px">' + (c.jm ? 'RENDRE UN VERDICT' : c.mode === 'faille' ? 'TROUVER LA FAILLE' : 'CHOISIS TON CAMP') + '</div>' +
        '<div style="flex:1;height:1px;background:rgba(255,255,255,.06)"></div>' +
      '</div>' +
      '<div style="display:flex;gap:10px;position:relative">' +
        (locked ?
          '<div style="width:100%;padding:16px;border-radius:16px;border:1.5px solid rgba(255,255,255,.08);background:rgba(255,255,255,.02);color:rgba(255,255,255,.35);font-size:14px;font-weight:700;text-align:center;cursor:pointer;font-family:\'Outfit\',sans-serif" onclick="lockMsg()">🔒 Affaire verrouillée</div>' :
          c.mode === 'faille' ?
          '<button style="width:100%;padding:16px;border-radius:16px;border:2px solid rgba(124,187,240,.35);background:rgba(124,187,240,.06);color:#7CBBF0;font-size:15px;font-weight:800;cursor:pointer;font-family:\'Outfit\',sans-serif" onclick="joinDuel(\'' + k + '\')">🔍 Trouver la faille</button>' :
          (c.jm ?
...
function startFirstDuel() {
  ...
  go('duel-dossier');
  var tot = (ciTiming ? ciTiming[0] : (c.pt || 180)), left = tot;
  clearInterval(prepI);
  uR('dd-ring', 1);
...
// ======================
// PAGE DE CHOIX (on propose, on n'impose pas)
// ======================
function buildFirstChoice() {
  var cl = CLIENTS.filter(function(c){ return c.id === me.clientId; })[0];
  var ci = cl && CASES[cl.sig] ? CASES[cl.sig] : null;
  var vp = cl && CASES[cl.vp] ? CASES[cl.vp] : null;
  var e1 = document.getElementById('fc-ci-name'); if (e1) e1.textContent = ci ? ci.n : '—';
  var e2 = document.getElementById('fc-vp-name'); if (e2) e2.textContent = vp ? vp.n : '—';
}

function startComparution() {
  var cl = CLIENTS.filter(function(c){ return c.id === me.clientId; })[0];
  if (!cl || !CASES[cl.sig]) return;
  ciTiming = [120, 120];
  joinDuelAs(cl.sig, 'defense');
}

function startVice() {
  var cl = CLIENTS.filter(function(c){ return c.id === me.clientId; })[0];
  if (!cl || !CASES[cl.vp]) return;
  ciTiming = null;
  startFaille(cl.vp);
}

// Affaire suivante (chaînage compte : fin d'affaire -> suivante)
function lockMsg() { alert("Terminez l'affaire de votre client pour ouvrir le prétoire."); }

function startFaille(id) {
  curCase = id;
  var c = CASES[id];
  if (!c) return;
  document.getElementById('faille-series').textContent = (c.t || '').toUpperCase();
  document.getElementById('faille-name').textContent = c.n;
  document.getElementById('faille-dos').textContent = c.dos || c.q;
  var wrap = document.getElementById('faille-options');
  wrap.innerHTML = '';
  (c.elements || []).forEach(function(el, i) {
    var b = document.createElement('button');
    b.className = 'faille-opt';
    b.id = 'fopt-' + i;
    b.textContent = el.t;
    b.onclick = function() { pickFaille(i); };
    wrap.appendChild(b);
  });
  document.getElementById('faille-result').style.display = 'none';
  document.getElementById('faille-next').style.display = 'none';
  go('faille-mode');
}

function pickFaille(i) {
  var c = CASES[curCase];
  if (!c || !c.elements) return;
  var correct = c.elements[i] && c.elements[i].ok;
  c.elements.forEach(function(el, j) {
    var b = document.getElementById('fopt-' + j);
    if (!b) return;
    b.onclick = null;
    b.style.cursor = 'default';
    if (el.ok) b.classList.add('faille-correct');
    else if (j === i) b.classList.add('faille-wrong');
    if (!el.ok && j !== i) b.style.opacity = '.4';
  });
  var res = document.getElementById('faille-result');
  res.style.display = 'block';
  res.innerHTML =
    (correct
      ? '<div style="color:#4ECB71;font-weight:900;font-size:17px;margin-bottom:10px;">\u2713 Faille trouv\u00e9e</div>'
      : '<div style="color:#FF4757;font-weight:900;font-size:17px;margin-bottom:10px;">\u2717 Ce n\'\u00e9tait pas la faille</div>') +
    '<div style="color:rgba(255,255,255,.6);font-size:13px;line-height:1.6;">' + (c.expl || '') + '</div>';
  me.duels = (me.duels || 0) + 1;
  if (me.email && !me.sigDone) {
    me.sigDone = true;
    if (window.db) window.db.ref('users/' + myUid + '/sigDone').set(true);
  }
  saveSession();
  var nb = document.getElementById('faille-next');
  nb.style.display = 'block';
  if (me.email) { nb.textContent = 'Affaire suivante \u2192'; nb.onclick = function() { nextCase(); }; }
  else { nb.textContent = 'Cr\u00e9er un compte pour continuer'; nb.onclick = function() { go('account-wall'); }; }
}
...
function leaveDuel() {
  ...
  if (!me.sigDone) { buildFirstChoice(); go('first-choice'); return; }
...
function joinDuel(id) {
  ...
  if (c.mode === 'faille') { startFaille(id); return; }
...
function goToSubmit() {
  ...
  document.getElementById('ds-case-name').textContent = c.n;
  go('duel-submit');
  var tot = (ciTiming ? ciTiming[1] : ((c || {}).wt || 360)), left = tot;
  clearInterval(prepI);
  uR('ds-ring', 1);
  document.getElementById('ds-timer').textContent = fT(left);
  prepI = setInterval(function() {
...
function afterSignup() {
  if (window.convertingGuest) {
    ...
    saveSession();
    if (window.db) {
      window.db.ref('users/' + myUid + '/sigDone').set(true);
