...
function K(x, n, t, q, dos, bd, ba, j) {
  ...
  return { pt: p[0], wt: p[1], vd: p[2], n: n, t: t, q: q, dos: dos || q, bd: bd || 'L\'accusé a agi selon ses convictions. Chaque décision était un choix de survie, pas de trahison.', ba: ba || 'Les faits sont accablants. Aucune excuse ne peut justifier les dommages causés aux victimes.', jm: j || false };
}
...
var ALL_CASES = {
  ...
  hampate1: K(3, 'Hampâté Bâ vs Tommy Shelby', 'Philosophie', 'Hampâté Bâ accuse Tommy Shelby d\'être un homme sans parole qui a érigé la trahison en méthode de gouvernement', 'Hampâté Bâ a consacré sa vie à défendre la tradition orale africaine. Au cœur de cette tradition, la parole donnée est un contrat sacré. Tommy Shelby promet la paix à Grace, la sécurité à sa famille, la liberté à Arthur. Aucune de ces promesses n\'a été tenue. Hampâté Bâ pose la question : un homme qui brise sa parole peut-il prétendre être un homme de pouvoir légitime ?', 'Tommy Shelby vit dans un monde où la parole ne vaut rien parce que personne autour de lui ne la respecte. Il adapte ses promesses à la survie.', 'Tommy a promis la paix à sa famille et a entraîné chacun dans une guerre après l\'autre. Hampâté Bâ dit : un homme sans parole n\'est qu\'un bruit de bouche. Il n\'existe pas.'),
  ...
  sakho1: K(1, 'Sakho vs Mangane', 'Sakho & Mangane', 'Mangane accuse Sakho de se croire au-dessus des lois qu\'il est censé faire respecter', 'Dakar, Sénégal. Sakho a l\'habitude de contourner les règles quand il estime que le résultat est juste. Il s\'introduit illégalement, il intimide des témoins, il manipule les procédures. Mangane lui reproche de se comporter comme un criminel pour arrêter des criminels.', 'Sakho attrape les coupables que la procédure laisserait filer. Dans un système judiciaire imparfait, un flic qui joue selon les mêmes règles que les criminels est parfois le seul qui peut gagner.', 'Si chaque flic décide seul quelles lois il respecte, le droit n\'existe plus. Ce que Sakho appelle pragmatisme, Mangane l\'appelle arbitraire.'),
  walter1: K(1, 'Walter vs Jesse', 'Breaking Bad', 'Jesse accuse Walter d\'avoir empoisonné un enfant de 8 ans pour le manipuler comme un pantin', 'Albuquerque. Jesse a découvert que c\'est Walter qui avait empoisonné Brock, délibérément, pour manipuler Jesse et le retourner contre Gus. Walter avait calculé la dose pour que l\'enfant survive. Il avait utilisé un enfant innocent comme pièce sur son échiquier.', 'Walter n\'a pas voulu tuer Brock. Il a calculé une dose qui ne mettait pas sa vie en danger. L\'objectif était d\'éliminer Gus Fring qui voulait les tuer tous les deux.', 'Walter White a empoisonné un enfant de 8 ans en secret. Il a regardé Jesse s\'effondrer d\'inquiétude tout en sachant qu\'il en était responsable.'),
  maitresse1: K(1, 'Marème vs Dialika', 'Maîtresse d\'un homme marié', 'Dialika accuse Marème d\'avoir détruit son foyer en connaissance de cause et sans le moindre remords', 'Dakar. Dialika est mariée à Baye Fall depuis des années. Marème est entrée dans cette équation en sachant pertinemment qu\'il était marié. Elle n\'a rien caché, elle a assumé sa position ouvertement.', 'Marème n\'a pas trahi Dialika. Elle ne lui a fait aucune promesse. C\'est Baye Fall qui a fait des vœux et qui les a brisés.', 'Marème savait. Elle a quand même choisi de continuer. La liberté individuelle s\'arrête là où elle détruit délibérément la vie d\'une autre personne.'),
  ...
  harvey1: K(1, 'Harvey vs Louis', 'Suits', 'Louis accuse Harvey d\'être un narcissique qui sabote ses collègues pour rester le seul génie du cabinet', 'New York, cabinet Pearson Specter. Harvey Specter est le meilleur fermeur du cabinet. Louis Litt travaille deux fois plus dur pour la moitié de la reconnaissance. Louis accuse Harvey de détruire systématiquement les opportunités des autres pour préserver son statut.', 'Harvey a construit sa réputation par des victoires que personne d\'autre ne pouvait obtenir. Le talent ne se partage pas, il se prouve.', 'Harvey traite Louis comme un inférieur depuis le premier jour. Il sabote, il humilie, il écarte. Le génie ne justifie pas la cruauté.'),
  dinercon1: K(1, 'Pignon vs Brochant', 'Le Dîner de Cons', 'Brochant accuse Pignon d\'avoir transformé une soirée en catastrophe totale et irréversible', 'Paris. Brochant a invité Pignon, comptable passionné de maquettes d\'allumettes, à son dîner. En quelques heures, Pignon a provoqué la fuite de sa femme, alerté le fisc, révélé une relation extraconjugale et déclenché une série de catastrophes en chaîne. Avec les meilleures intentions du monde.', 'Pignon n\'a rien fait de mal intentionnellement. C\'est Brochant qui a créé ce jeu cruel et méprisable. Il récolte ce qu\'il a semé.', 'La bonne intention ne suffit pas. Pignon a détruit le mariage de Brochant, alerté le fisc, fait fuir sa maîtresse. Les dégâts sont réels.'),
  ...
  heritage1: K(1, 'Le Fils vs L\'Oncle', 'Héritage', 'Le fils accuse l\'oncle d\'avoir profité du deuil familial pour s\'emparer de l\'héritage', 'Côte d\'Ivoire. Le père est mort, laissant derrière lui une propriété et une famille fracturée. L\'oncle s\'est positionné comme gestionnaire naturel pendant le deuil, prenant des décisions sans consultation.', 'L\'oncle a géré l\'héritage parce que le fils était incapable de le faire dans l\'immédiat du deuil. Les décisions ont été prises dans l\'intérêt de la famille au sens large.', 'L\'oncle a attendu que son frère soit dans la terre pour mettre la main sur ce qu\'il n\'avait pas réussi à obtenir de son vivant.'),
  dadie1: K(3, 'Dadié vs Harvey Specter', 'Philosophie', 'Dadié accuse Harvey Specter de traiter la justice comme un jeu d\'ego plutôt qu\'un outil de vérité', 'Bernard Dadié, père de la littérature ivoirienne, a toujours défendu que la parole doit servir la vérité et la dignité humaine. Harvey Specter, lui, est le meilleur fermeur de New York — pas parce qu\'il cherche la vérité, mais parce qu\'il cherche la victoire. Il défend les coupables, écrase les innocents, et appelle ça du génie.', 'Harvey Specter obtient des résultats que personne d\'autre ne peut obtenir. Dans un système imparfait, un avocat qui gagne protège mieux ses clients qu\'un avocat qui cherche la vérité. Dadié vit dans un monde d\'idéaux. Harvey vit dans la réalité des tribunaux.', 'Harvey Specter a défendu des criminels, détruit des innocents, manipulé des preuves — tout ça en se regardant dans le miroir avec satisfaction. Dadié écrit que la parole doit élever l\'homme. Harvey utilise la parole pour l\'écraser. Ce n\'est pas du droit, c\'est du spectacle.', true),
  soeurs1: K(1, 'Karen vs Terrence', '7 Sœurs', 'Karen accuse Terrence d\'avoir effacé l\'identité de six de ses filles pour en faire une seule', 'Europe dystopique. La loi de l\'enfant unique interdit à chaque famille d\'avoir plus d\'un enfant. Terrence Settman a eu des septuplées. Plutôt que de sacrifier six d\'entre elles, il les a fait vivre sous l\'identité d\'une seule femme : Karen. Chaque jour de la semaine appartient à l\'une des sœurs.', 'Terrence a sauvé sept vies dans un monde qui n\'en voulait qu\'une. La contrainte de partager une identité est douloureuse, mais l\'alternative était la mort.', 'Terrence a décidé seul que six de ses filles n\'auraient pas le droit d\'exister sous leur propre nom. Survivre dans la clandestinité n\'est pas vivre.'),
  tag1: K(2, 'Tag vs Éric', 'Foot 2 Rue', 'Éric accuse Tag de sacrifier la victoire collective sur l\'autel de son ego et de son show', 'Paris, terrain de foot 2 rue. Tag est le joueur le plus talentueux de l\'équipe — tout le monde le sait, lui le premier. Éric lui reproche de traiter chaque match comme un show personnel. Quand l\'équipe a besoin d\'une passe décisive, Tag dribble. Quand l\'équipe a besoin de discipline, Tag improvise. Son talent est réel. Sa lâcheté collective aussi.', 'Tag marque les buts qui gagnent les matchs. Sans son talent, l\'équipe n\'existerait même pas. Le collectif a besoin d\'une star pour exister.', 'Tag préfère rater un dribble incroyable que réussir une passe simple. Il confond le talent avec le droit d\'ignorer les autres. Le foot c\'est pas un sport solo.'),
  nuitdesrois1: K(4, 'Roman vs Barbe Noire', 'La Nuit des Rois', 'Roman accuse Barbe Noire d\'avoir instauré un règne de terreur déguisé en tradition à la MACA', 'Abidjan, prison de la MACA. Barbe Noire est le chef incontesté de la prison. Son pouvoir repose sur une tradition : chaque nuit, le Roman doit raconter une histoire jusqu\'à l\'aube. S\'il s\'arrête, il meurt. Roman, nouveau détenu désigné pour ce rôle, doit raconter pendant toute la nuit de la lune rouge.', 'Barbe Noire a transformé un espace de violence brute en un espace où la parole a une valeur. La tradition du Roman a créé une nuit où l\'intelligence vaut plus que les poings.', 'Barbe Noire a inventé une tradition pour justifier son pouvoir de vie et de mort. Forcer un homme à raconter des histoires toute la nuit sous peine d\'exécution, c\'est de la torture avec un emballage poétique.', true),
  topboy1: K(1, 'Sully vs Aaron', 'Top Boy', 'Aaron accuse Sully d\'avoir tué son frère Jamie de sang-froid et détruit sa famille pour toujours', 'Summerhouse, Est de Londres. Jamie Tovell avait tout fait pour sortir ses frères Aaron et Stefan de la rue. Quand Dushane a ordonné la mort de Jamie, c\'est Sully qui a appuyé sur la gâchette. Pas par haine. Par business.', 'Sully n\'a pas assassiné Jamie. Il a exécuté une décision qui dépassait les deux hommes. Dans l\'économie de la rue, la trahison se paye de la vie.', 'Sully a regardé Jamie dans les yeux et a tiré. Par choix. Jamie essayait de s\'en sortir. Aaron n\'a plus de frère. Appeler ça du business, c\'est cracher sur sa mémoire.'),
  beauvoir1: K(3, 'Beauvoir vs Princesse Sarah', 'Philosophie', 'Beauvoir accuse la série d\'avoir fabriqué pendant des décennies un modèle féminin basé sur la souffrance silencieuse et la soumission', 'Simone de Beauvoir a fondé le féminisme existentiel sur une idée centrale : on ne naît pas femme, on le devient. Les structures de domination sont construites et peuvent être déconstruites. Princesse Sarah est une petite fille noble déchue qui endure toutes les humiliations sans jamais se révolter. Elle souffre, elle pardonne, elle reste douce. Et à la fin, elle est récompensée pour sa bonté passive.', 'Sarah n\'est pas passive, elle est résiliente. Sa force est intérieure. Dans un monde qui l\'écrase, elle choisit de ne pas se laisser corrompre. Ce n\'est pas de la soumission, c\'est de la dignité.', 'Princesse Sarah enseigne aux petites filles que souffrir en silence est vertueux, que la révolte est laide, que la bonté passive finit par être récompensée. C\'est un mensonge. Et ce mensonge a été diffusé pendant des décennies dans les foyers du monde entier. Le vrai féminisme c\'est la colère, pas le pardon perpétuel.', true),
  valide1: K(1, 'Apash vs William', 'Validé', 'William accuse Apash d\'avoir vendu son authenticité contre des streams et trahi ceux qui l\'ont construit', 'Paris, banlieue. Apash est né dans la cité. Son rap parlait de la rue, de la galère, de ceux qui restent. William était là depuis le début. Quand Apash a percé, il a changé — ses textes, ses partenaires, ses interviews.', 'Apash a réussi là où des milliers ont échoué. Évoluer n\'est pas trahir. Rester enfermé dans une image de banlieue pour satisfaire ceux qui n\'ont pas eu le courage de partir, c\'est accepter sa propre prison.', 'Apash a bâti sa carrière sur la promesse implicite d\'une parole vraie. Il a monétisé cette confiance puis changé de monde sans se retourner.'),
  nietzsche1: K(3, 'Nietzsche vs Tag', 'Philosophie', 'Nietzsche accuse Tag d\'avoir le talent du surhomme mais de choisir délibérément la médiocrité du show plutôt que la grandeur du dépassement', 'Friedrich Nietzsche a théorisé le surhomme comme celui qui crée ses propres valeurs et se dépasse lui-même. Tag, joueur prodige du foot 2 rue, a un talent qui dépasse tous ses adversaires. Mais Nietzsche observe quelque chose d\'inquiétant : Tag utilise son talent non pas pour se dépasser, mais pour impressionner.', 'Tag joue comme il ressent les choses. Le football de rue c\'est de l\'art autant que du sport. Nietzsche lui-même valorisait la création et l\'instinct. Tag ne suit pas les règles parce qu\'il en a créé d\'autres. C\'est ça le surhomme.', 'Nietzsche parlait de se dépasser soi-même, pas d\'épater les autres. Tag a le talent pour changer le jeu mais il choisit de briller dans sa propre lumière plutôt que d\'élever ceux qui l\'entourent. Le vrai surhomme construit. Tag, lui, performe.', true),
  bloom1: K(1, 'Bloom vs Icy', 'Les Winx', 'Icy accuse Bloom d\'être une imposteur qui a construit sa légitimité sur une identité volée et des pouvoirs hérités qu\'elle n\'a pas mérités', 'Alfea, école des fées. Bloom a grandi en pensant être une humaine ordinaire avant de découvrir qu\'elle est la princesse de la planète Domino et porteuse du Feu du Destin. Icy lui reproche de se poser en héroïne alors que tout ce qu\'elle a, elle le doit à sa naissance et au hasard, pas à son travail ou son mérite.', 'Bloom n\'a pas choisi ses origines, mais elle a choisi d\'assumer la responsabilité qui venait avec. Elle aurait pu fuir. Elle s\'est battue. La légitimité ne vient pas de la naissance mais de ce qu\'on fait avec ce qu\'on a reçu.', 'Bloom arrive à Alfea sans formation, sans effort préalable, et s\'impose comme la plus puissante grâce à des pouvoirs innés. Elle représente exactement ce que le mérite devrait combattre : le privilège de naissance déguisé en destin.')
};
...
function buildHome() {
  ...
  if (!ci) return;
  ci.innerHTML = '';
  var h = document.getElementById('home').offsetHeight || 700;

  sorted.forEach(function(k, idx) {
    var c = CASES[k];
    var card = document.createElement('div');
    card.style.cssText = 'height: 100dvh; scroll-snap-align: start; position: relative; overflow: hidden; display: flex; flex-direction: column; justify-content: center; padding: 0 28px 80px; background: linear-gradient(180deg, #1a0e3a 0%, #140820 40%, #0a0a12 100%);';
...
// ======================
function switchVdTab(el, id) {
  el.parentNode.querySelectorAll('div').forEach(function(d) {
    d.style.borderBottomColor = 'transparent';
    d.style.color = '#555';
  });
  el.style.borderBottomColor = '#FF7A2E';
  el.style.color = '#FF7A2E';
  document.getElementById('vd-enc').style.display = id === 'vd-enc' ? 'block' : 'none';
  document.getElementById('vd-fin').style.display = id === 'vd-fin' ? 'block' : 'none';
}
...
function tryFirebaseLogin(e, p, err) {
  ...
  // Cherche d'abord par uid direct
  window.db.ref('users/' + myUid).once('value', function(snap) {
    ...
    if (d && d.email) {
      ...
      // Pas trouvé par uid → cherche par email dans toute la base
...
function shareVerdict() {
  var c = CASES[curCase] || {};
  var cn = c.n ? c.n.split(' vs ') : [''];
  var side = myRole === 'defense' ? 'défendu ' + cn[0] : 'accusé ' + cn[0];
  var msg = 'J\'ai ' + side + ' sur D\'brief. Tu fais mieux ? ' + location.href;
  if (navigator.share) {
    navigator.share({ title: 'D\'brief', text: msg });
  } else {
...
function shareRoom() {
  var c = CASES[curCase] || {};
  var url = location.origin + location.pathname + '?room=' + currentRoom;
  var msg = 'Viens plaider contre moi sur ' + c.n + ' !\n' + url;
  if (navigator.share) {
    navigator.share({ title: 'D\'brief — ' + c.n, text: msg, url: url });
  } else {
...
function react(duelKey, side, type) {
  if (!window.db) return;
  var path = 'public-duels/' + duelKey + '/reactions_' + side + '/' + type + '/' + myUid;
...
function submitOnboarding() {
  ...
  waitDb(function() {
    ...
    window.db.ref('users/' + myUid + '/duels').set(1);
  });
...
function initMainApp() {
  // Gestion du splash screen avec fallback
  setTimeout(function() {
    if (document.getElementById('splash-intro')?.classList.contains('on')) {
      go('splash');
    }
  }, 2500);

  // Fallback si Firebase ne se charge pas
  setTimeout(function() {
    if (document.getElementById('splash-intro')?.classList.contains('on')) {
      console.warn("Firebase non chargé, passage forcé à splash");
      go('splash');
    }
  }, 5000);
      ...
      try {
        ...
        if (u && u.name && u.email) {
          ...
          if (window.firebaseLoaded) {
            ...
            // Si Firebase n'est pas chargé, on va sur splash
            go('splash');
          }
          return;
        }
